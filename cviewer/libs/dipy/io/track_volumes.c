/* Generated by Cython 0.12.1 on Wed Jul 28 15:25:31 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__cviewer__libs__dipy__dipy__io__track_volumes
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from cviewer.libs.dipy.dipy.io.track_volumes */
...
#define __Pyx_MODULE_NAME "cviewer.libs.dipy.dipy.io.track_volumes"
int __pyx_module_is_main_cviewer__libs__dipy__dipy__io__track_volumes = 0;

/* Implementation of cviewer.libs.dipy.dipy.io.track_volumes */
...
/* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":14
 * 
 * 
...
static PyObject *__pyx_pf_7cviewer_4libs_4dipy_4dipy_2io_13track_volumes_track_counts(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cviewer.libs.dipy.dipy.io.track_volumes.track_counts");
  return NULL;
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":49
 *        passed through the voxel.
 *     '''
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":50
 *     '''
 *     vol_dims = np.asarray(vol_dims).astype(np.int)
 *     vox_sizes = np.asarray(vox_sizes).astype(np.double)             # <<<<<<<<<<<<<<
 *     n_voxels = np.prod(vol_dims)
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":51
 *     vol_dims = np.asarray(vol_dims).astype(np.int)
 *     vox_sizes = np.asarray(vox_sizes).astype(np.double)
 *     n_voxels = np.prod(vol_dims)             # <<<<<<<<<<<<<<
 *     # output track counts array, flattened
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":54
 *     # output track counts array, flattened
 *     cdef cnp.ndarray[cnp.int_t, ndim=1] tcs = \
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":57
 *     # pointer to output track indices
 *     cdef cnp.npy_intp i
 *     if return_elements:             # <<<<<<<<<<<<<<
 *         el_inds = {}
 ...
 */
  ...
  if (__pyx_t_7) {
    ...
    /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":58
 *     cdef cnp.npy_intp i
 *     if return_elements:
 *         el_inds = {}             # <<<<<<<<<<<<<<
 *     # cython numpy pointer to individual track array
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":71
 *     cdef int vd[3]
 *     cdef double vxs[3]
 *     for cno in range(3):             # <<<<<<<<<<<<<<
 *         vd[cno] = vol_dims[cno]
 ...
 */
  for (__pyx_t_8 = 0; __pyx_t_8 < 3; __pyx_t_8+=1) {
    ...
    /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":72
 *     cdef double vxs[3]
 *     for cno in range(3):
 *         vd[cno] = vol_dims[cno]             # <<<<<<<<<<<<<<
 *         vxs[cno] = vox_sizes[cno]
 ...
 */
    ...
    /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":73
 *     for cno in range(3):
 *         vd[cno] = vol_dims[cno]
 *         vxs[cno] = vox_sizes[cno]             # <<<<<<<<<<<<<<
 *     # return_elements to C native
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":75
 *         vxs[cno] = vox_sizes[cno]
 *     # return_elements to C native
 *     cdef int ret_elf = <int>return_elements             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":77
 *     cdef int ret_elf = <int>return_elements
 *     # x slice size (C array ordering)
 *     cdef cnp.npy_intp yz = vd[1] * vd[2]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":78
 *     # x slice size (C array ordering)
 *     cdef cnp.npy_intp yz = vd[1] * vd[2]
 *     for tno in range(len(tracks)):             # <<<<<<<<<<<<<<
 *         t = tracks[tno].astype(np.float)
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_11; __pyx_t_8+=1) {
    ...
    /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":79
 *     cdef cnp.npy_intp yz = vd[1] * vd[2]
 *     for tno in range(len(tracks)):
 *         t = tracks[tno].astype(np.float)             # <<<<<<<<<<<<<<
 *         # set to find unique voxel points in track
 ...
 */
    ...
    /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":81
 *         t = tracks[tno].astype(np.float)
 *         # set to find unique voxel points in track
 *         in_inds = set()             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":83
 *         in_inds = set()
 *         # the loop below is time-critical
 *         for pno in range(t.shape[0]):             # <<<<<<<<<<<<<<
 *             in_pt = t[pno]
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_16; __pyx_t_9+=1) {
      ...
      /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":84
 *         # the loop below is time-critical
 *         for pno in range(t.shape[0]):
 *             in_pt = t[pno]             # <<<<<<<<<<<<<<
 *             # Round to voxel coordinates, and set coordinates outside
 ...
 */
      ...
      /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":87
 *             # Round to voxel coordinates, and set coordinates outside
 *             # volume to volume edges
 *             for cno in range(3):             # <<<<<<<<<<<<<<
 ...
 */
      for (__pyx_t_18 = 0; __pyx_t_18 < 3; __pyx_t_18+=1) {
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":88
 *             # volume to volume edges
 *             for cno in range(3):
 *                 v = <int>floor(in_pt[cno] / vxs[cno] + 0.5)             # <<<<<<<<<<<<<<
 *                 if v < 0:
 ...
 */
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":89
 *             for cno in range(3):
 *                 v = <int>floor(in_pt[cno] / vxs[cno] + 0.5)
 *                 if v < 0:             # <<<<<<<<<<<<<<
 *                     v = 0
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":90
 *                 v = <int>floor(in_pt[cno] / vxs[cno] + 0.5)
 *                 if v < 0:
 *                     v = 0             # <<<<<<<<<<<<<<
 *                 elif v >= vd[cno]:
 ...
 */
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":91
 *                 if v < 0:
 *                     v = 0
 *                 elif v >= vd[cno]:             # <<<<<<<<<<<<<<
 *                     v = vd[cno]-1 # last index for this dimension
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":92
 *                     v = 0
 *                 elif v >= vd[cno]:
 *                     v = vd[cno]-1 # last index for this dimension             # <<<<<<<<<<<<<<
 *                 out_pt[cno] = v
 ...
 */
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":93
 *                 elif v >= vd[cno]:
 *                     v = vd[cno]-1 # last index for this dimension
 *                 out_pt[cno] = v             # <<<<<<<<<<<<<<
 *             # calculate element number in flattened tcs array
 ...
 */
      ...
      /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":95
 *                 out_pt[cno] = v
 *             # calculate element number in flattened tcs array
 *             el_no = out_pt[0] * yz + out_pt[1] * vd[2] + out_pt[2]             # <<<<<<<<<<<<<<
 *             # discard duplicates
 ...
 */
      ...
      /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":97
 *             el_no = out_pt[0] * yz + out_pt[1] * vd[2] + out_pt[2]
 *             # discard duplicates
 *             if el_no in in_inds:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":98
 *             # discard duplicates
 *             if el_no in in_inds:
 *                 continue             # <<<<<<<<<<<<<<
 *             in_inds.add(el_no)
 ...
 */
      ...
      /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":99
 *             if el_no in in_inds:
 *                 continue
 *             in_inds.add(el_no)             # <<<<<<<<<<<<<<
 *             # set elements into object array
 ...
 */
      ...
      /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":101
 *             in_inds.add(el_no)
 *             # set elements into object array
 *             if ret_elf:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_18) {
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":102
 *             # set elements into object array
 *             if ret_elf:
 *                 key = (out_pt[0], out_pt[1], out_pt[2])             # <<<<<<<<<<<<<<
 *                 val = tno
 ...
 */
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":103
 *             if ret_elf:
 *                 key = (out_pt[0], out_pt[1], out_pt[2])
 *                 val = tno             # <<<<<<<<<<<<<<
 *                 if tcs[el_no]:
 ...
 */
        ...
        /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":104
 *                 key = (out_pt[0], out_pt[1], out_pt[2])
 *                 val = tno
 *                 if tcs[el_no]:             # <<<<<<<<<<<<<<
 *                     el_inds[key].append(val)
 ...
 */
        ...
        if (__pyx_t_23) {
          ...
          /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":105
 *                 val = tno
 *                 if tcs[el_no]:
 *                     el_inds[key].append(val)             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
        ...
        /*else*/ {
          ...
          /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":107
 *                     el_inds[key].append(val)
 *                 else:
 *                     el_inds[key] = [val]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":109
 *                     el_inds[key] = [val]
 *             # set value into counts
 *             tcs[el_no] += 1             # <<<<<<<<<<<<<<
 *     if ret_elf:
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":110
 *             # set value into counts
 *             tcs[el_no] += 1
 *     if ret_elf:             # <<<<<<<<<<<<<<
 *         return tcs.reshape(vol_dims), el_inds
 ...
 */
  ...
  if (__pyx_t_8) {
    ...
    /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":111
 *             tcs[el_no] += 1
 *     if ret_elf:
 *         return tcs.reshape(vol_dims), el_inds             # <<<<<<<<<<<<<<
 *     return tcs.reshape(vol_dims)
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":112
 *     if ret_elf:
 *         return tcs.reshape(vol_dims), el_inds
 *     return tcs.reshape(vol_dims)             # <<<<<<<<<<<<<<
 * 
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("track_counts"), (PyCFunction)__pyx_pf_7cviewer_4libs_4dipy_4dipy_2io_13track_volumes_track_counts, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7cviewer_4libs_4dipy_4dipy_2io_13track_volumes_track_counts)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  if (__pyx_module_is_main_cviewer__libs__dipy__dipy__io__track_volumes) {
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":6
 * 
 * '''
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/stephan/Dev/PyWorkspace/connectomeviewer/cviewer/libs/dipy/dipy/io/track_volumes.pyx":1
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cviewer.libs.dipy.dipy.io.track_volumes");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cviewer.libs.dipy.dipy.io.track_volumes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
