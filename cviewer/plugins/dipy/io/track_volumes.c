/* Generated by Cython 0.12.1 on Tue Mar  9 18:42:29 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__dipy__io__track_volumes
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from dipy.io.track_volumes */
...
#define __Pyx_MODULE_NAME "dipy.io.track_volumes"
int __pyx_module_is_main_dipy__io__track_volumes = 0;

/* Implementation of dipy.io.track_volumes */
...
static char __pyx_k_8[] = " A type of -*- python -*- file\n\nCounting incidence of tracks in voxels of volume\n\n";
static char __pyx_k_9[] = "track_counts (line 14)";
...
/* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":14
 * 
 * 
...
static PyObject *__pyx_pf_4dipy_2io_13track_volumes_track_counts(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_v_ret_elf;
  npy_intp __pyx_v_yz;
  PyObject *__pyx_v_in_inds;
  PyObject *__pyx_v_key;
  PyObject *__pyx_v_val;
  Py_buffer __pyx_bstruct_tcs;
  Py_ssize_t __pyx_bstride_0_tcs = 0;
  Py_ssize_t __pyx_bshape_0_tcs = 0;
  Py_buffer __pyx_bstruct_in_pt;
  Py_ssize_t __pyx_bstride_0_in_pt = 0;
  Py_ssize_t __pyx_bshape_0_in_pt = 0;
  ...
  __Pyx_RefNannySetupContext("track_counts");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      case  1:
      values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__vol_dims);
      if (likely(values[1])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("track_counts", 0, 3, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__vox_sizes);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("track_counts", 0, 3, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      if (kw_args > 0) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "track_counts") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    ...
    __pyx_v_return_elements = __pyx_k_1;
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  4:
      __pyx_v_return_elements = PyTuple_GET_ITEM(__pyx_args, 3);
      case  3:
      __pyx_v_vox_sizes = PyTuple_GET_ITEM(__pyx_args, 2);
      __pyx_v_vol_dims = PyTuple_GET_ITEM(__pyx_args, 1);
  ...
  __Pyx_RaiseArgtupleInvalid("track_counts", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("dipy.io.track_volumes.track_counts");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF(__pyx_v_tracks);
  __Pyx_INCREF(__pyx_v_vol_dims);
  __Pyx_INCREF(__pyx_v_vox_sizes);
  __Pyx_INCREF(__pyx_v_return_elements);
  __pyx_v_n_voxels = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_el_inds = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_t = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_v_in_pt = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_v_in_inds = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_key = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_val = Py_None; __Pyx_INCREF(Py_None);
  __pyx_bstruct_tcs.buf = NULL;
  __pyx_bstruct_t.buf = NULL;
  __pyx_bstruct_in_pt.buf = NULL;

  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":49
 *        passed through the voxel.
 *     '''
 ...
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__asarray); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__astype); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__int); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":50
 *     '''
 *     vol_dims = np.asarray(vol_dims).astype(np.int)
 *     vox_sizes = np.asarray(vox_sizes).astype(np.double)             # <<<<<<<<<<<<<<
 *     n_voxels = np.prod(vol_dims)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__asarray); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__astype); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__double); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":51
 *     vol_dims = np.asarray(vol_dims).astype(np.int)
 *     vox_sizes = np.asarray(vox_sizes).astype(np.double)
 *     n_voxels = np.prod(vol_dims)             # <<<<<<<<<<<<<<
 *     # output track counts array, flattened
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__prod); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_v_n_voxels);
  __pyx_v_n_voxels = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":54
 *     # output track counts array, flattened
 *     cdef cnp.ndarray[cnp.int_t, ndim=1] tcs = \
 ...
 */
  ...
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__int); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__dtype), __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyEval_CallObjectWithKeywords(__pyx_t_3, __pyx_t_1, ((PyObject *)__pyx_t_2)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_tcs, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_tcs = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_tcs.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_tcs = __pyx_bstruct_tcs.strides[0];
      __pyx_bshape_0_tcs = __pyx_bstruct_tcs.shape[0];
    }
  }
  __pyx_t_6 = 0;
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":57
 *     # pointer to output track indices
 *     cdef cnp.npy_intp i
 *     if return_elements:             # <<<<<<<<<<<<<<
 *         el_inds = {}
 ...
 */
  __pyx_t_7 = __Pyx_PyObject_IsTrue(__pyx_v_return_elements); if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__pyx_t_7) {

    /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":58
 *     cdef cnp.npy_intp i
 *     if return_elements:
 *         el_inds = {}             # <<<<<<<<<<<<<<
 *     # cython numpy pointer to individual track array
 ...
 */
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":71
 *     cdef int vd[3]
 *     cdef double vxs[3]
 *     for cno in range(3):             # <<<<<<<<<<<<<<
 *         vd[cno] = vol_dims[cno]
 ...
 */
  for (__pyx_t_8 = 0; __pyx_t_8 < 3; __pyx_t_8+=1) {
    ...
    /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":72
 *     cdef double vxs[3]
 *     for cno in range(3):
 *         vd[cno] = vol_dims[cno]             # <<<<<<<<<<<<<<
 *         vxs[cno] = vox_sizes[cno]
 ...
 */
    __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_vol_dims, __pyx_v_cno, sizeof(int), PyInt_FromLong); if (!__pyx_t_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_9 = __Pyx_PyInt_AsInt(__pyx_t_5); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    (__pyx_v_vd[__pyx_v_cno]) = __pyx_t_9;

    /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":73
 *     for cno in range(3):
 *         vd[cno] = vol_dims[cno]
 *         vxs[cno] = vox_sizes[cno]             # <<<<<<<<<<<<<<
 *     # return_elements to C native
 ...
 */
    __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_vox_sizes, __pyx_v_cno, sizeof(int), PyInt_FromLong); if (!__pyx_t_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_10 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_10 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    (__pyx_v_vxs[__pyx_v_cno]) = __pyx_t_10;
  }

  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":75
 *         vxs[cno] = vox_sizes[cno]
 *     # return_elements to C native
 *     cdef int ret_elf = <int>return_elements             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_8 = __Pyx_PyInt_AsInt(__pyx_v_return_elements); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_ret_elf = ((int)__pyx_t_8);

  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":77
 *     cdef int ret_elf = <int>return_elements
 *     # x slice size (C array ordering)
 *     cdef cnp.npy_intp yz = vd[1] * vd[2]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":78
 *     # x slice size (C array ordering)
 *     cdef cnp.npy_intp yz = vd[1] * vd[2]
 *     for tno in range(len(tracks)):             # <<<<<<<<<<<<<<
 *         t = tracks[tno].astype(np.float)
 ...
 */
  __pyx_t_11 = PyObject_Length(__pyx_v_tracks); if (unlikely(__pyx_t_11 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_11; __pyx_t_8+=1) {
    __pyx_v_tno = __pyx_t_8;

    /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":79
 *     cdef cnp.npy_intp yz = vd[1] * vd[2]
 *     for tno in range(len(tracks)):
 *         t = tracks[tno].astype(np.float)             # <<<<<<<<<<<<<<
 *         # set to find unique voxel points in track
 *         in_inds = set()
 */
    __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_tracks, __pyx_v_tno, sizeof(int), PyInt_FromLong); if (!__pyx_t_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_2 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__astype); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_1 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__float); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __pyx_t_1 = 0;
    __pyx_t_1 = PyObject_Call(__pyx_t_2, __pyx_t_5, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __pyx_t_12 = ((PyArrayObject *)__pyx_t_1);
    {
      ...
      __pyx_t_9 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_t, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
      if (unlikely(__pyx_t_9 < 0)) {
        PyErr_Fetch(&__pyx_t_13, &__pyx_t_14, &__pyx_t_15);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_t, (PyObject*)__pyx_v_t, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
    ...
    /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":81
 *         t = tracks[tno].astype(np.float)
 *         # set to find unique voxel points in track
 *         in_inds = set()             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_DECREF(__pyx_v_in_inds);
    __pyx_v_in_inds = ((PyObject *)__pyx_t_1);
    __pyx_t_1 = 0;

    /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":83
 *         in_inds = set()
 *         # the loop below is time-critical
 *         for pno in range(t.shape[0]):             # <<<<<<<<<<<<<<
 *             in_pt = t[pno]
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_16; __pyx_t_9+=1) {
      ...
      /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":84
 *         # the loop below is time-critical
 *         for pno in range(t.shape[0]):
 *             in_pt = t[pno]             # <<<<<<<<<<<<<<
 *             # Round to voxel coordinates, and set coordinates outside
 ...
 */
      __pyx_t_1 = __Pyx_GetItemInt(((PyObject *)__pyx_v_t), __pyx_v_pno, sizeof(int), PyInt_FromLong); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      ...
      {
        __Pyx_BufFmt_StackElem __pyx_stack[1];
        __Pyx_SafeReleaseBuffer(&__pyx_bstruct_in_pt);
        __pyx_t_18 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_in_pt, (PyObject*)__pyx_t_17, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
        if (unlikely(__pyx_t_18 < 0)) {
          PyErr_Fetch(&__pyx_t_15, &__pyx_t_14, &__pyx_t_13);
          if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_in_pt, (PyObject*)__pyx_v_in_pt, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
        ...
        __pyx_bstride_0_in_pt = __pyx_bstruct_in_pt.strides[0];
        __pyx_bshape_0_in_pt = __pyx_bstruct_in_pt.shape[0];
        if (unlikely(__pyx_t_18 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_17 = 0;
      __Pyx_DECREF(((PyObject *)__pyx_v_in_pt));
      __pyx_v_in_pt = ((PyArrayObject *)__pyx_t_1);
      __pyx_t_1 = 0;

      /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":87
 *             # Round to voxel coordinates, and set coordinates outside
 *             # volume to volume edges
 *             for cno in range(3):             # <<<<<<<<<<<<<<
 ...
 */
      for (__pyx_t_18 = 0; __pyx_t_18 < 3; __pyx_t_18+=1) {
        ...
        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":88
 *             # volume to volume edges
 *             for cno in range(3):
 *                 v = <int>floor(in_pt[cno] / vxs[cno] + 0.5)             # <<<<<<<<<<<<<<
 *                 if v < 0:
 ...
 */
        ...
        __pyx_t_20 = -1;
        if (__pyx_t_19 < 0) {
          __pyx_t_19 += __pyx_bshape_0_in_pt;
          if (unlikely(__pyx_t_19 < 0)) __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_19 >= __pyx_bshape_0_in_pt)) __pyx_t_20 = 0;
        ...
        __pyx_t_21 = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_bstruct_in_pt.buf, __pyx_t_19, __pyx_bstride_0_in_pt));
        __pyx_t_10 = (__pyx_v_vxs[__pyx_v_cno]);
        if (unlikely(__pyx_t_10 == 0)) {
          PyErr_Format(PyExc_ZeroDivisionError, "float division");
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_v_v = ((int)floor(((__pyx_t_21 / __pyx_t_10) + 0.5)));

        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":89
 *             for cno in range(3):
 *                 v = <int>floor(in_pt[cno] / vxs[cno] + 0.5)
 *                 if v < 0:             # <<<<<<<<<<<<<<
 *                     v = 0
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":90
 *                 v = <int>floor(in_pt[cno] / vxs[cno] + 0.5)
 *                 if v < 0:
 *                     v = 0             # <<<<<<<<<<<<<<
 *                 elif v >= vd[cno]:
 ...
 */
        ...
        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":91
 *                 if v < 0:
 *                     v = 0
 *                 elif v >= vd[cno]:             # <<<<<<<<<<<<<<
 *                     v = vd[cno]-1 # last index for this dimension
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":92
 *                     v = 0
 *                 elif v >= vd[cno]:
 *                     v = vd[cno]-1 # last index for this dimension             # <<<<<<<<<<<<<<
 *                 out_pt[cno] = v
 ...
 */
        ...
        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":93
 *                 elif v >= vd[cno]:
 *                     v = vd[cno]-1 # last index for this dimension
 *                 out_pt[cno] = v             # <<<<<<<<<<<<<<
 *             # calculate element number in flattened tcs array
 ...
 */
      ...
      /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":95
 *                 out_pt[cno] = v
 *             # calculate element number in flattened tcs array
 *             el_no = out_pt[0] * yz + out_pt[1] * vd[2] + out_pt[2]             # <<<<<<<<<<<<<<
 *             # discard duplicates
 ...
 */
      ...
      /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":97
 *             el_no = out_pt[0] * yz + out_pt[1] * vd[2] + out_pt[2]
 *             # discard duplicates
 *             if el_no in in_inds:             # <<<<<<<<<<<<<<
 *                 continue
 *             in_inds.add(el_no)
 */
      __pyx_t_1 = __Pyx_PyInt_to_py_npy_intp(__pyx_v_el_no); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_7 = ((PySequence_Contains(__pyx_v_in_inds, __pyx_t_1))); if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_7) {

        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":98
 *             # discard duplicates
 *             if el_no in in_inds:
 *                 continue             # <<<<<<<<<<<<<<
 *             in_inds.add(el_no)
 ...
 */
      ...
      /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":99
 *             if el_no in in_inds:
 *                 continue
 *             in_inds.add(el_no)             # <<<<<<<<<<<<<<
 *             # set elements into object array
 *             if ret_elf:
 */
      __pyx_t_1 = PyObject_GetAttr(__pyx_v_in_inds, __pyx_n_s__add); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyInt_to_py_npy_intp(__pyx_v_el_no); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      ...
      __pyx_t_5 = 0;
      __pyx_t_5 = PyObject_Call(__pyx_t_1, __pyx_t_2, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

      /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":101
 *             in_inds.add(el_no)
 *             # set elements into object array
 *             if ret_elf:             # <<<<<<<<<<<<<<
 ...
 *                 val = tno
 */
      __pyx_t_18 = __pyx_v_ret_elf;
      if (__pyx_t_18) {

        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":102
 *             # set elements into object array
 *             if ret_elf:
 *                 key = (out_pt[0], out_pt[1], out_pt[2])             # <<<<<<<<<<<<<<
 *                 val = tno
 *                 if tcs[el_no]:
 */
        __pyx_t_5 = PyInt_FromLong((__pyx_v_out_pt[0])); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_2 = PyInt_FromLong((__pyx_v_out_pt[1])); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_1 = PyInt_FromLong((__pyx_v_out_pt[2])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        ...
        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":103
 *             if ret_elf:
 *                 key = (out_pt[0], out_pt[1], out_pt[2])
 *                 val = tno             # <<<<<<<<<<<<<<
 *                 if tcs[el_no]:
 ...
 */
        __pyx_t_3 = PyInt_FromLong(__pyx_v_tno); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_v_val);
        __pyx_v_val = __pyx_t_3;
        __pyx_t_3 = 0;

        /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":104
 *                 key = (out_pt[0], out_pt[1], out_pt[2])
 *                 val = tno
 *                 if tcs[el_no]:             # <<<<<<<<<<<<<<
 *                     el_inds[key].append(val)
 *                 else:
 */
        __pyx_t_22 = __pyx_v_el_no;
        __pyx_t_18 = -1;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_bshape_0_tcs;
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_22 >= __pyx_bshape_0_tcs)) __pyx_t_18 = 0;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_23 = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_bstruct_tcs.buf, __pyx_t_22, __pyx_bstride_0_tcs));
        if (__pyx_t_23) {

          /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":105
 *                 val = tno
 *                 if tcs[el_no]:
 *                     el_inds[key].append(val)             # <<<<<<<<<<<<<<
 *                 else:
 *                     el_inds[key] = [val]
 */
          __pyx_t_3 = PyObject_GetItem(__pyx_v_el_inds, __pyx_v_key); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_3);
          __pyx_t_1 = __Pyx_PyObject_Append(__pyx_t_3, __pyx_v_val); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          goto __pyx_L18;
        ...
        /*else*/ {
          ...
          /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":107
 *                     el_inds[key].append(val)
 *                 else:
 *                     el_inds[key] = [val]             # <<<<<<<<<<<<<<
 ...
 */
          ...
          if (PyObject_SetItem(__pyx_v_el_inds, __pyx_v_key, ((PyObject *)__pyx_t_1)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":109
 *                     el_inds[key] = [val]
 *             # set value into counts
 *             tcs[el_no] += 1             # <<<<<<<<<<<<<<
 *     if ret_elf:
 ...
 */
      ...
      __pyx_t_18 = -1;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_bshape_0_tcs;
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_18 = 0;
      } else if (unlikely(__pyx_t_24 >= __pyx_bshape_0_tcs)) __pyx_t_18 = 0;
      if (unlikely(__pyx_t_18 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_18);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_bstruct_tcs.buf, __pyx_t_24, __pyx_bstride_0_tcs) += 1;
      __pyx_L11_continue:;
    }
  }

  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":110
 *             # set value into counts
 *             tcs[el_no] += 1
 *     if ret_elf:             # <<<<<<<<<<<<<<
 *         return tcs.reshape(vol_dims), el_inds
 ...
 */
  __pyx_t_8 = __pyx_v_ret_elf;
  if (__pyx_t_8) {

    /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":111
 *             tcs[el_no] += 1
 *     if ret_elf:
 *         return tcs.reshape(vol_dims), el_inds             # <<<<<<<<<<<<<<
 *     return tcs.reshape(vol_dims)
 ...
 */
    ...
    __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_tcs), __pyx_n_s__reshape); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    ...
    PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_v_el_inds);
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":112
 *     if ret_elf:
 *         return tcs.reshape(vol_dims), el_inds
 *     return tcs.reshape(vol_dims)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyObject_GetAttr(((PyObject *)__pyx_v_tcs), __pyx_n_s__reshape); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 112; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_v_vol_dims);
  PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_vol_dims);
  __Pyx_GIVEREF(__pyx_v_vol_dims);
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_tcs);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_in_pt);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_t);
  ...
  __Pyx_DECREF(__pyx_v_vol_dims);
  __Pyx_DECREF(__pyx_v_vox_sizes);
  __Pyx_DECREF(__pyx_v_return_elements);
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("track_counts"), (PyCFunction)__pyx_pf_4dipy_2io_13track_volumes_track_counts, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4dipy_2io_13track_volumes_track_counts)},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inittrack_volumes(void); /*proto*/
PyMODINIT_FUNC inittrack_volumes(void)
#else
PyMODINIT_FUNC PyInit_track_volumes(void); /*proto*/
PyMODINIT_FUNC PyInit_track_volumes(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_track_volumes(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("track_volumes"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_8), 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_dipy__io__track_volumes) {
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":6
 * 
 * '''
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/media/Daten/Python/dipy/dipy/io/track_volumes.pyx":1
 ...
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__track_counts); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init dipy.io.track_volumes");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dipy.io.track_volumes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
