...
from cviewer.plugins.cff.interfaces.i_cfile import ICFile
...
##############################################################################
class ConnectomeFilePlugin(Plugin):
    ...
    CFILE = 'cviewer.plugins.cff.cfile'

    # The connectome file extension point.
    cfiles = ExtensionPoint(
        List(ICFile), id=CFILE, desc="""
    ...
    def _service_offers_default(self):
        ...
        cfile_service_offer = ServiceOffer(
            protocol = 'cviewer.plugins.cff.cfile.CFile',
            factory = 'cviewer.plugins.cff.cfile.CFile'
        )
    ...
    def _get_cff_service(self):
        ...
        """
        return self.application.get_service('cviewer.plugins.cff.cfile.CFile')
