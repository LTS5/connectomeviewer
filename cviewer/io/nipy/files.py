...
import cviewer.io.nipy.imageformats as formats

from cviewer.io.nipy.core.api import Image, is_image
...
def save(img, filename, dtype=None):
    ...
    >>> from cviewer.io.nipy.core.api import fromarray
    >>> from cviewer.io.nipy.api import save_image
