...
from cviewer.io.nipy.core.reference.coordinate_map import Affine
from cviewer.io.nipy.core.reference.coordinate_map import product as cmap_product
from cviewer.io.nipy.core.reference.coordinate_system import CoordinateSystem
from cviewer.io.nipy.core.reference.array_coords import ArrayCoordMap
...
class Image(object):
    ...
    Notes
    -----
    Images can be created through the module functions.  See cviewer.io.nipy for
    image IO such as ``load`` and ``save``

    Examples
    --------

    >>> from cviewer.io.nipy.core.image import image
