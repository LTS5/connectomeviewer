...
* Download the `installation script <http://github.com/unidesigner/connectomeviewer/raw/master/scripts/install_cviewer.sh>`_ (Ubuntu 9.10 or higher / Fedora 11 or higher supported)
